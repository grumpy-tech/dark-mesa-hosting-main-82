...
export const AnimatedBackground = () => {
  ...
  useEffect(() => {
    ...
    const drawBeam = (beam: Beam) => {
      ...
      gradient.addColorStop(0, `rgba(8,217,214,0)`);
      gradient.addColorStop(0.2, `rgba(8,217,214,${pulsingOpacity * 0.5})`);
      gradient.addColorStop(0.5, `rgba(8,217,214,${pulsingOpacity})`);
      gradient.addColorStop(0.8, `rgba(8,217,214,${pulsingOpacity * 0.5})`);
