  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: "Works on Phones & Tablets", value: true, included: true },
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold">We'll Support You From The Beginning</h1>
              ...
              <Card key={plan.name} className={`p-6 border-2 ${plan.popular ? 'border-primary' : 'border-border'}`}>
                <div className="text-center mb-6 pb-6 border-b border-border">
                  <div className={`inline-block rounded-2xl bg-gradient-to-br ${plan.color} p-6 border-2 ${plan.popular ? 'border-primary' : 'border-border'} relative mb-4`}>
                    ...
                    <div className="text-4xl font-bold mt-4">${plan.monthly}<span className="text-lg text-muted-foreground">/mo</span></div>
                    <div className="text-sm text-muted-foreground mt-2">Build: ${plan.buildPrice}</div>
                  </div>
