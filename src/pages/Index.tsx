...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 text-center overflow-hidden" style={{ background: 'radial-gradient(ellipse 80% 70% at center, hsl(177 60% 40% / 0.07), hsl(210 14% 92%) 50%, hsl(var(--background)))' }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-7">
          ...
          >
            ...
            <span style={{ color: 'hsl(177 60% 40%)' }}>Without the Agency Price Tag.</span>
          </motion.h1>
          ...
          >
            Built, hosted, and maintained — all in for{" "}
            <strong className="text-foreground">$39/mo</strong>. You run your business. I handle the rest.
          </motion.p>
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="py-16 md:py-24" style={{ background: 'linear-gradient(135deg, hsl(222 22% 14%), hsl(222 22% 10%))' }}>
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl text-center">
          ...
          >
            ...
            <p className="text-xs mt-5" style={{ color: 'hsl(210 15% 55%)' }}>
